    ...
    try {
      ...
      if (
        ...
        return res.status(400).json({
          ...
          message:
            "Unsupported platform URL. YouTube and Instagram downloader are coming soon.",
        });
      }
    ...
    try {
      ...
      if (
        ...
        return res.status(400).json({
          ...
          message:
            "Unsupported media platform. YouTube and Instagram downloader are coming soon.",
        });
      }
